...
The `--editable` install makes `ollim-bot` and
[claude-history](https://github.com/Ollim-AI/claude-history) available as
global commands. `claude-history` is a CLI tool the bot's subagents use to
